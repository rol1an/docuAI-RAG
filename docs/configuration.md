...
|----------|---------|-------------|
| `PROJECT_NAME` | `docuai` | Display name for the project |
...
| `POSTGRES_DB` | `docuai` | Database name |
...
| `AI_FRAMEWORK` | `langchain` | AI framework (informational) |
...
| `LOGFIRE_SERVICE_NAME` | `docuai` | Service name in Logfire dashboard |
